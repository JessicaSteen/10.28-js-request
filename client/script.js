...
const changeBack = (event) => {
    event.target.classList.toggle("orginalColor")
}
...
const repeatMyParam = (res) => {
    ...
    // const repeating = document.querySelector('#repeat-text')
    // console.log(repeating.textContent);
}
...
const attachQuery = () => {
    axios.get('http://localhost:3000/query-test?what') 
    .then(response => {
        console.log(response.data)
    })
}
